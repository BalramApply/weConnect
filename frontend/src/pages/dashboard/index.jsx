...
export default function dashboard() {
  ...
  const [showSuccessMessage, setShowSuccessMessage] = useState(false);
   ...
   // Method to clear success message after 5 seconds
  ...
  const validateFileSize = (file) => {
    ...
    if (file && file.size > maxSize) {
      ...
      setFileSizeError(`Image size (${fileSizeKB}KB) exceeds the 50KB limit`);
      return false;
    }
    setFileSizeError("");
    return true;
...
const handleUpload = async () => {
    ...
    if (fileContent && !validateFileSize(fileContent)) {
      return;
    }
  ...
  // Clear success message after 5 seconds using useEffect as backup
  useEffect(() => {
          ...
          <div className={styles.scrollComponent}>
            <div className={styles.wrapper}>
              <div className={styles.createPostContainer}>
                ...
                {/* Error Messages */}
                {(fileSizeError || postState.uploadError) && (
                ...
                {/* File Preview */}
                {fileContent && !fileSizeError && (
                  <div className={styles.filePreview}>
                    <span>Selected: {fileContent.name}</span>
                ...
                {postContent.length > 0 && (
                  <div 
                    ...
                    className={`${styles.uploadButton} ${
                      postState.isLoading ? styles.loading : ''
                    }`}
                    disabled={postState.isLoading || fileSizeError}
                  >
                    {postState.isLoading ? 'Uploading...' : 'Post'}
                  </div>
                )}
              </div>
                  ...
                  return (
                    <div key={post._id} className={styles.singleCard}>
                      <div className={styles.singleCard_profileContainer}>
                        ...
                        <div>
                          <div
                            className={styles.singleCard_profileContainer_name}
                          >
                        ...
                        <div className={styles.singleComment} key={comment._id}>
                          ...
                          >
                            <img
                              src={
                                comment.userId?.profilePicture
                                  ...
                                  : `${BASE_URL}/default-avatar.png` // fallback image
                              }
                              alt={`${
                              ...
                              className={styles.userProfile}
                              onError={(e) => {
                                // If image fails to load, try without BASE_URL or use a default
                                console.log(
                                  "Image load failed for:",
                                  e.target.src
                                );
                                e.target.src = `${BASE_URL}/default-avatar.png`;
                              }}
                              onLoad={() => {
                            ...
                            <div>
                              ...
                              <div className={styles.username_comment}>
